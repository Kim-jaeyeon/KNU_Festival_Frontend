...
const Home: React.FC = () => {
  ...
  return (
    ...
    >
      <div
        ref={scroll1Ref}
        className="w-full min-h-[932px] flex flex-col items-center overflow-x-hidden bg-[url('/assets/home/BGimg/BackImg1.png')] bg-cover bg-center "
      >
        <div
        ...
        >
          ...
          >
            <img
              src="/assets/home/LayerFrame1/1LayerFrame1.png"
              alt=""
          ...
          <div className="mt-[4px] mx-auto grid grid-cols-2 gap-[9px]">
            <img
              src="/assets/home/LayerFrame1/1LayerFrame2.png"
              alt=""
              className="w-full h-full"
              onClick={() => navigate("/booth-foodtruck/대운동장")}
            />
            <img
              src="/assets/home/LayerFrame1/1LayerFrame3.png"
              alt=""
              className="w-full h-full"
              onClick={() => navigate("/photo-festival")}
            />
            <img
              src="/assets/home/LayerFrame1/1LayerFrame4.png"
              alt=""
              className="w-full h-full"
              onClick={() => navigate("/boothRecommendLoading")}
            />
            <img
              src="/assets/home/LayerFrame1/1LayerFrame5.png"
              alt=""
              className="w-full h-full"
      ...
      <div className="w-full min-h-[932px] pt-[50px] bg-cover bg-center bg-no-repeat bg-[url('/assets/home/BGimg/BackImg3.png')] bg-cover bg-center">
        <HomeCard3
          logoSrc="/assets/home/lineup/extext.svg"
          mainImgSrc="/assets/home/lineup/eximg.svg"
          dayText="DAY1"
      ...
      <div className="w-full min-h-[932px] pt-[64px] bg-cover bg-center bg-no-repeat bg-[url('/assets/home/BGimg/BackImg5.png')] bg-cover bg-center">
        <HomeCard2
          title="대운동장"
          subtitle="공연, 푸드트럭"
          details="자세히 보기"
