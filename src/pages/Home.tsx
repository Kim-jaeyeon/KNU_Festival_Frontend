...
const Home: React.FC = () => {
  ...
  return (
    ...
    >
      <div ref={scroll1Ref} className="w-full min-h-[932px] flex flex-col items-center overflow-x-hidden bg-[url('/assets/home/BGimg/BackImg1.webp')] bg-cover bg-center "
     >
        <div className={`text-center mt-[95px] transition-all duration-1000 ${isVisible.logo ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className={`mt-[30px] w-full h-full px-4 transition-all duration-1000 ${isVisible.cards ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="relative w-full h-auto" onClick={() => navigate("/timetable")}>
              <img src="/assets/home/LayerFrame1/1LayerFrame1.webp" alt="" className="w-full h-auto" />
              {/* 이미지 위 글씨 */}
            ...
            <div className="mt-[4px] mx-auto grid grid-cols-2 gap-[9px]">
              <img src="/assets/home/LayerFrame1/1LayerFrame2.webp" alt="" className="w-full h-full" onClick={() => navigate("/booth-foodtruck")}/>
              <img src="/assets/home/LayerFrame1/1LayerFrame3.webp" alt="" className="w-full h-full" onClick={() => navigate("/photo-festival")}/>
              <img src="/assets/home/LayerFrame1/1LayerFrame4.webp" alt="" className="w-full h-full" onClick={() => navigate("/boothRecommendLoading")}/>
              <img src="/assets/home/LayerFrame1/1LayerFrame5.webp" alt="" className="w-full h-full" onClick={() => navigate("/faq")}/>
            </div>
          </div>
            ...
            <div 
            className="w-full min-h-[932px] pt-[50px] bg-cover bg-center bg-no-repeat bg-[url('/assets/home/BGimg/BackImg3.webp')] bg-cover bg-center">
            ...
            <div 
              className="w-full min-h-[932px] pt-[64px] bg-cover bg-center bg-no-repeat bg-[url('/assets/home/BGimg/BackImg5.webp')] bg-cover bg-center">
